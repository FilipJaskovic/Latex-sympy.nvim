...
% :LatexSympyOp perm_group order
% (select both lines together)
[1,2,0]
[1,0,2]

% :LatexSympyOp perm_group stabilizer 0
% (select both lines together)
[1,2,0]
[1,0,2]

% :LatexSympyOp prufer encode 4
% (select all edges together)
[0,1]
[1,2]
[1,3]

% :LatexSympyOp prufer decode
[1,1]

% :LatexSympyOp gray sequence 3
0

% :LatexSympyOp gray bin_to_gray 1011
0

% :LatexSympyOp gray gray_to_bin 1110
0
